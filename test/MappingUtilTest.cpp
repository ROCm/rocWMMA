...
struct Kernel
{
    ...
    void thread2matrixWrapper()
    {
        ...
        hipLaunchKernelGGL(
            (thread2matrix<BlockM, BlockN, InputT, Layout>),
            gridDim,
            blockDim,
            0, // sharedMemBytes
            0, // stream
...
using Implementations = testing::Types<
    ...
    std::tuple<I<32>, I<32>, float32_t, row_major>, std::tuple<I<32>, I<32>, float32_t, col_major>,
