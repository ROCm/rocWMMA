...
struct Kernel
{
    ...
    {
        hipLaunchKernelGGL(
            (defaultConstructorTest<DataT, VecSize, SubVecSize>),
            gridDim,
            blockDim,
            0, // sharedMemBytes
            0); // stream
        ...
        hipLaunchKernelGGL(
            (otherConstructorTest<DataT, VecSize, SubVecSize>),
            gridDim,
            blockDim,
            0, // sharedMemBytes
            0); // stream
    ...
    {
        hipLaunchKernelGGL(
            (index<DataT, VecSize, SubVecSize>),
            gridDim,
            blockDim,
            0, // sharedMemBytes
            0); // stream
        ...
        hipLaunchKernelGGL(
            (dereference<DataT, VecSize, SubVecSize>),
            gridDim,
            blockDim,
            0, // sharedMemBytes
            0); // stream
    ...
    {
        hipLaunchKernelGGL(
            (getSize<DataT, VecSize, SubVecSize>),
            gridDim,
            blockDim,
            0, // sharedMemBytes
            0); // stream
    ...
    {
        hipLaunchKernelGGL(
            (vectIterator<DataT, VecSize, SubVecSize>),
            gridDim,
            blockDim,
            0, // sharedMemBytes
            0); // stream
        ...
        hipLaunchKernelGGL(
            (vectIteratorAccess<DataT, VecSize, SubVecSize>),
            gridDim,
            blockDim,
            0, // sharedMemBytes
            0); // stream     
        ...
        hipLaunchKernelGGL(
            (vectIteratorInc<DataT, VecSize, SubVecSize>),
            gridDim,
            blockDim,
            0, // sharedMemBytes
            0); // stream 
        ...
        hipLaunchKernelGGL(
            (vectIteratorDec<DataT, VecSize, SubVecSize>),
            gridDim,
            blockDim,
            0, // sharedMemBytes
            0); // stream 
        ...
        hipLaunchKernelGGL(
            (vectIteratorPrev<DataT, VecSize, SubVecSize>),
            gridDim,
            blockDim,
            0, // sharedMemBytes
            0); // stream 
        ...
        hipLaunchKernelGGL(
            (vectIteratorNext<DataT, VecSize, SubVecSize>),
            gridDim,
            blockDim,
            0, // sharedMemBytes
            0); // stream 
...
using Implementations = testing::Types<
    ...
    std::tuple<float32_t, I<1024>, I<128>>, std::tuple<hfloat16_t, I<1024>, I<128>>, 
    std::tuple<float16_t, I<1024>, I<128>>, std::tuple<int8_t, I<1024>, I<128>>, 
    std::tuple<int32_t, I<1024>, I<128>>, std::tuple<uint8_t, I<1024>, I<128>>,
