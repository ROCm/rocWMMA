...
template <uint32_t BlockM,
          ...
          typename DataT,
          typename LayoutA>
__global__ void loadContaminationTest(DataT const* a_in,
                                      DataT*       a_out,
                                      uint32_t     paddedM,
                                      uint32_t     paddedN,
                                      uint32_t M,
...
template <uint32_t BlockM,
          ...
          typename DataT,
          typename LayoutA>
__global__ void storeContaminationTest(DataT const* a_in,
                                      DataT*       a_out,
                                      uint32_t     paddedM,
                                      uint32_t     paddedN,
                                      uint32_t     M,
...
struct Kernel
{
           ...
           uint32_t NI)
    {
        ...
        gridDim = dim3(ceilDiv(M,  BlockM * TBlockX / AMDGCN_WAVE_SIZE), ceilDiv(N, BlockN * TBlockY));
    ...
    void LoadContaminationTestWrapper()
    {
        ...
        hipLaunchKernelGGL(
            (loadContaminationTest<BlockM, BlockN, BlockK, DataT, DataLayout>),
            gridDim,
            blockDim,
            0, // sharedMemBytes
            0, // stream
        ...
        //Compare
        EXPECT_TRUE((compareEqualPadded<DataT, DataLayout>(ref, matrix, M, N, DataT(PADDING_VALUE))));
    ...
    void StoreContaminationTestWrapper()
    {
        ...
        CHECK_HIP_ERROR(hipMemcpy(d_arr_out, d_arr_out_padded.data(), (M+2)*(N+2)*sizeof(DataT), 
                                    hipMemcpyHostToDevice));

        hipLaunchKernelGGL(
            (storeContaminationTest<BlockM, BlockN, BlockK, DataT, DataLayout>),
            gridDim,
            blockDim,
            0, // sharedMemBytes
            0, // stream
        ...
        //Compare
        EXPECT_TRUE((compareEqualPadded<DataT, DataLayout>(matrix, ref, M, N, DataT(PADDING_VALUE))));
        CHECK_HIP_ERROR(hipFree(d_arr_in));
        CHECK_HIP_ERROR(hipFree(d_arr_out));        
    }
...
struct ContaminationTestWrapper<std::tuple<BlockM, BlockN, BlockK, DataT, DataLayout>> : public testing::Test
{
    ...
    void SetUp() override 
    {
        ...
        for(auto tblock : thread_block)
        {
            ...
            {
                obj[i++] = new Kernel<BlockM::value, BlockN::value, BlockK::value, DataT, DataLayout>
...
using Implementations = testing::Types<
    ...
    std::tuple<I<16>, I<16>, I<16>, float32_t, row_major>, std::tuple<I<16>, I<16>, I<16>, float32_t, col_major>,
    std::tuple<I<16>, I<16>, I<16>, float16_t, row_major>, std::tuple<I<16>, I<16>, I<16>, float16_t, col_major>,
    std::tuple<I<16>, I<16>, I<16>, hfloat16_t, row_major>, std::tuple<I<16>, I<16>, I<16>, hfloat16_t, col_major>,
    std::tuple<I<16>, I<16>, I<16>, int8_t, row_major>, std::tuple<I<16>, I<16>, I<16>, int8_t, col_major>,
    std::tuple<I<16>, I<16>, I<16>, int32_t, row_major>, std::tuple<I<16>, I<16>, I<16>, int32_t, col_major>,
    std::tuple<I<16>, I<16>, I<16>, uint8_t, row_major>, std::tuple<I<16>, I<16>, I<16>, uint8_t, col_major>,
    std::tuple<I<16>, I<16>, I<16>, uint32_t, row_major>, std::tuple<I<16>, I<16>, I<16>, uint32_t, col_major>,
    std::tuple<I<32>, I<32>, I<32>, float16_t, row_major>, std::tuple<I<32>, I<32>, I<32>, float16_t, col_major>,
    std::tuple<I<32>, I<32>, I<32>, hfloat16_t, row_major>, std::tuple<I<32>, I<32>, I<32>, hfloat16_t, col_major>,
    std::tuple<I<32>, I<32>, I<32>, int8_t, row_major>, std::tuple<I<32>, I<32>, I<32>, int8_t, col_major>,
    std::tuple<I<32>, I<32>, I<32>, int32_t, row_major>, std::tuple<I<32>, I<32>, I<32>, int32_t, col_major>,
    std::tuple<I<32>, I<32>, I<32>, uint8_t, row_major>, std::tuple<I<32>, I<32>, I<32>, uint8_t, col_major>,
    std::tuple<I<32>, I<32>, I<32>, uint32_t, row_major>, std::tuple<I<32>, I<32>, I<32>, uint32_t, col_major>>;
